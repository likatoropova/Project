...
//                 console.log('Current exercise:', current_exercise);
//
...
//             let errorMsg = 'Ошибка начала теста';
//             if (err.response) {
//                 errorMsg = err.response.data?.message || err.response.data?.error || `Ошибка ${err.response.status}`;
//             } else if (err.request) {
//                 errorMsg = 'Сервер не отвечает. Проверьте подключение.';
//             } else {
...
//             } else {
//                 // Для гостя убираем префикс 'guest_' из attemptId
//                 finalAttemptId = attemptId.replace('guest_', '');
//                 url = `/guest/test-attempts/${finalAttemptId}/result`;
//             }
//
//             console.log('Saving result - Original attemptId:', attemptId);
//             console.log('Saving result - Final attemptId:', finalAttemptId);
...
//             }
//
//             console.log('Completing test - Original attemptId:', attemptId);
//             console.log('Completing test - Final attemptId:', finalAttemptId);
