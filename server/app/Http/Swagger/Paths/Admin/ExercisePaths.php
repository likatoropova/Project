 ...
 *     summary="Получить список всех упражнений с фильтрацией",
 *     description="Возвращает список всех упражнений с информацией об оборудовании и количеством тренировок. Поддерживает поиск, фильтрацию и пагинацию",
 ...
 *         name="muscle_group",
 *         in="query",
 *         description="Фильтр по группе мышц",
 *         required=false,
 *         @OA\Schema(type="string", example="Грудные")
 *     ),
 *     @OA\Parameter(
 *         name="equipment_id",
 *         in="query",
 ...
 *         required=false,
 *         @OA\Schema(type="string", enum={"id", "title", "muscle_group", "created_at", "updated_at"}, default="created_at")
 *     ),
 *     @OA\Parameter(
 *         name="sort_dir",
 *         in="query",
